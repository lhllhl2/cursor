package com.jasolar.mis.framework.gateway.filter.grey;
...
public class GrayReactiveLoadBalancerClientFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        // 修改 by fiifoxconn：将 lb 替换成 grayLb，表示灰度负载均衡
        ...
        String serviceId = ObjectUtil.isNull(requestUri) ? null : requestUri.getHost();
    ...
    private Mono<Response<ServiceInstance>> choose(Request<RequestDataContext> lbRequest, String serviceId,
        ...
        // 修改 by fiifoxconn：直接创建 GrayLoadBalancer 对象
