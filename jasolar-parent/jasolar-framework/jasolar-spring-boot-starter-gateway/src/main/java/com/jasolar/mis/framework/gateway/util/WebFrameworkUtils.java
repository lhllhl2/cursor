 ...
 * Web 工具类
 * <p>
 * copy from jasolar-spring-boot-starter-web 的 WebFrameworkUtils 类
 *
 * @author zhaohuang
 */
@Slf4j
public final class WebFrameworkUtils {
    ...
    public static String getClientIP(ServerWebExchange exchange, String... otherHeaderNames) {
        ...
        ip = Optional.ofNullable(exchange.getRequest()).map(ServerHttpRequest::getRemoteAddress).map(InetSocketAddress::getHostString)
