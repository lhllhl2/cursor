...
public class CorsFilter implements WebFilter {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, WebFilterChain chain) {
        ...
        // 暴露响应头，确保前端能接收到Content-Disposition等头
        headers.add("Access-Control-Expose-Headers", "Content-Disposition,Content-Type,Content-Length,Content-Encoding,Cache-Control");
