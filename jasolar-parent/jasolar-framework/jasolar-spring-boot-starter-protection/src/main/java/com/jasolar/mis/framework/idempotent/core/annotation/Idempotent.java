package com.jasolar.mis.framework.idempotent.core.annotation;
...
public @interface Idempotent {
    ...
    /** 返回的异常代码 */
    String errorCode() default GlobalErrorCodeConstants.CODE_REPEATED_REQUEST;

    /**
     * 使用的 Key 解析器
     *
     * @see UserIdempotentKeyResolver 用户级别, 默认
     * @see GlobalIdempotentKeyResolver 全局级别
     * @see ExpressionIdempotentKeyResolver 自定义表达式，通过 {@link #keyArg()} 计算
     */
    Class<? extends IdempotentKeyResolver> keyResolver() default UserIdempotentKeyResolver.class;
