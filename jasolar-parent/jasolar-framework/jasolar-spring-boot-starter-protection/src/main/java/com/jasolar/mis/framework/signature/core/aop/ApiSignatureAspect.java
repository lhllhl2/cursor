package com.jasolar.mis.framework.signature.core.aop;
...
import com.jasolar.mis.framework.signature.core.annotation.ApiSignature;
import com.jasolar.mis.framework.signature.core.redis.ApiSignatureRedisDAO;
...
public class ApiSignatureAspect {
    ...
    public void beforePointCut(JoinPoint joinPoint, ApiSignature signature) {
        ...
        throw new ServiceException(BAD_REQUEST.getCode(),
                CharSequenceUtil.blankToDefault(signature.message(), BAD_REQUEST.getMsg()));
    }
    ...
    public boolean verifySignature(ApiSignature signature, HttpServletRequest request) {
        ...
        if (ObjectUtil.notEqual(clientSignature, serverSignature)) {
            return false;
        }
    ...
    private boolean verifyHeaders(ApiSignature signature, HttpServletRequest request) {
        ...
        String nonce = request.getHeader(signature.nonce());
        if (CharSequenceUtil.length(nonce) < 10) {
            return false;
        }
    ...
    private String buildSignatureString(ApiSignature signature, HttpServletRequest request, String appSecret) {
        ...
        String requestBody = CharSequenceUtil.nullToDefault(ServletUtils.getBody(request), ""); // 请求体
