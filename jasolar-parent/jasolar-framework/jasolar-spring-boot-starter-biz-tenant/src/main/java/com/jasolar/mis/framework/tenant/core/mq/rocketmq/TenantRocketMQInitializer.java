package com.jasolar.mis.framework.tenant.core.mq.rocketmq;
...
public class TenantRocketMQInitializer implements BeanPostProcessor {
    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) throws BeansException {
        if (bean instanceof DefaultRocketMQListenerContainer defaultRocketMQListenerContainer) {
            DefaultRocketMQListenerContainer container = defaultRocketMQListenerContainer;
            initTenantConsumer(container.getConsumer());
        } else if (bean instanceof RocketMQTemplate rocketMQTemplate) {
            RocketMQTemplate template = rocketMQTemplate;
