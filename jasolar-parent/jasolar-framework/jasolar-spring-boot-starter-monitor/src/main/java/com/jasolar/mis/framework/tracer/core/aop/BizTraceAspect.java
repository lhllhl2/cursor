package com.jasolar.mis.framework.tracer.core.aop;
...
import com.jasolar.mis.framework.common.util.spring.SpringExpressionUtils;
import com.jasolar.mis.framework.tracer.core.annotation.BizTrace;
import com.jasolar.mis.framework.tracer.core.util.TracerFrameworkUtils;
...
public class BizTraceAspect {
    ...
    private String getOperationName(ProceedingJoinPoint joinPoint, BizTrace trace) {
        // 自定义操作名
        if (CharSequenceUtil.isNotEmpty(trace.operationName())) {
