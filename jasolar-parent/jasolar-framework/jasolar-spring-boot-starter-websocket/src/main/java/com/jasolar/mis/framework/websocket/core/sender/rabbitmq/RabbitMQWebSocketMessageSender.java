package com.jasolar.mis.framework.websocket.core.sender.rabbitmq;
...
public class RabbitMQWebSocketMessageSender extends AbstractWebSocketMessageSender {
    ...
    private void sendRabbitMQMessage(String sessionId, Long userId, Integer userType,
        ...
        RabbitMQWebSocketMessage mqMessage = RabbitMQWebSocketMessage.builder().sessionId(sessionId).userId(userId).userType(userType)
                .messageType(messageType).messageContent(messageContent).build();
