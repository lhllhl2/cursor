package com.jasolar.mis.framework.websocket.core.handler;

import cn.hutool.core.text.CharSequenceUtil;
import cn.hutool.core.util.TypeUtil;
import com.jasolar.mis.framework.common.util.json.JsonUtils;
import com.jasolar.mis.framework.tenant.core.util.TenantUtils;
import com.jasolar.mis.framework.websocket.core.listener.WebSocketMessageListener;
import com.jasolar.mis.framework.websocket.core.message.JsonWebSocketMessage;
...
public class JsonWebSocketMessageHandler extends TextWebSocketHandler {
    ...
    protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
        ...
        try {
            ...
            if (CharSequenceUtil.isEmpty(jsonMessage.getType())) {
