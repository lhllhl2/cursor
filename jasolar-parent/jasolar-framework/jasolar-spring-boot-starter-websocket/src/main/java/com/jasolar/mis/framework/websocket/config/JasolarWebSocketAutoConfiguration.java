package com.jasolar.mis.framework.websocket.config;

import com.jasolar.mis.framework.mq.redis.config.JasolarRedisMQConsumerAutoConfiguration;
import com.jasolar.mis.framework.mq.redis.core.RedisMQTemplate;
import com.jasolar.mis.framework.websocket.core.handler.JsonWebSocketMessageHandler;
import com.jasolar.mis.framework.websocket.core.listener.WebSocketMessageListener;
import com.jasolar.mis.framework.websocket.core.security.LoginUserHandshakeInterceptor;
import com.jasolar.mis.framework.websocket.core.security.WebSocketAuthorizeRequestsCustomizer;
import com.jasolar.mis.framework.websocket.core.sender.kafka.KafkaWebSocketMessageConsumer;
import com.jasolar.mis.framework.websocket.core.sender.kafka.KafkaWebSocketMessageSender;
import com.jasolar.mis.framework.websocket.core.sender.local.LocalWebSocketMessageSender;
import com.jasolar.mis.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageConsumer;
import com.jasolar.mis.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageSender;
import com.jasolar.mis.framework.websocket.core.sender.redis.RedisWebSocketMessageConsumer;
import com.jasolar.mis.framework.websocket.core.sender.redis.RedisWebSocketMessageSender;
import com.jasolar.mis.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageConsumer;
import com.jasolar.mis.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageSender;
import com.jasolar.mis.framework.websocket.core.session.WebSocketSessionHandlerDecorator;
import com.jasolar.mis.framework.websocket.core.session.WebSocketSessionManager;
import com.jasolar.mis.framework.websocket.core.session.WebSocketSessionManagerImpl;
 ...
 * @author zhaohuang
 */
@AutoConfiguration(before = JasolarRedisMQConsumerAutoConfiguration.class) // before FiifoxconnRedisMQConsumerAutoConfiguration 的原因是，需要保证 RedisWebSocketMessageConsumer 先创建，才能创建 RedisMessageListenerContainer
@EnableWebSocket // 开启 websocket
@ConditionalOnProperty(prefix = "jasolar.websocket", value = "enable", matchIfMissing = true) // 允许使用 fiifoxconn.websocket.enable=false 禁用 websocket
@EnableConfigurationProperties(WebSocketProperties.class)
public class JasolarWebSocketAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "jasolar.websocket", name = "sender-type", havingValue = "local")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "jasolar.websocket", name = "sender-type", havingValue = "redis")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "jasolar.websocket", name = "sender-type", havingValue = "rocketmq")
    public static class RocketMQWebSocketMessageSenderConfiguration {
        ...
        public RocketMQWebSocketMessageSender rocketMQWebSocketMessageSender(
                ...
                @Value("${jasolar.websocket.sender-rocketmq.topic}") String topic) {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "jasolar.websocket", name = "sender-type", havingValue = "rabbitmq")
    public static class RabbitMQWebSocketMessageSenderConfiguration {
         ...
         */
        @Bean
        public TopicExchange websocketTopicExchange(@Value("${jasolar.websocket.sender-rabbitmq.exchange}") String exchange) {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "jasolar.websocket", name = "sender-type", havingValue = "kafka")
    public static class KafkaWebSocketMessageSenderConfiguration {
        ...
        public KafkaWebSocketMessageSender kafkaWebSocketMessageSender(
                ...
                @Value("${jasolar.websocket.sender-kafka.topic}") String topic) {
