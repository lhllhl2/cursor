package com.jasolar.mis.framework.common.util.date;
...
import com.jasolar.mis.framework.common.enums.DateIntervalEnum;
...
public class LocalDateTimeUtils {
     ...
     */
    private static final LocalDateTime EMPTY_TIME = buildTime(1970, 1, 1);

    /**
     * 获取空的 LocalDateTime 对象
     *
     * @return 空的 LocalDateTime 对象
     */
     ...
     * @return
     */
    public static LocalDateTime min(@Nonnull LocalDateTime a, @Nonnull LocalDateTime b) {
     ...
     * @return
     */
    public static LocalDateTime max(@Nonnull LocalDateTime a, @Nonnull LocalDateTime b) {
    ...
    public static List<LocalDateTime[]> getDateRangeList(LocalDateTime startTime, LocalDateTime endTime, Integer interval) {
        ...
        case QUARTER:
            while (startTime.isBefore(endTime)) {
                ...
                LocalDateTime quarterEnd = quarterOfYear == 4 ? startTime.with(TemporalAdjusters.lastDayOfYear()).plusDays(1).minusNanos(1)
    ...
    public static String formatDateRange(LocalDateTime startTime, LocalDateTime endTime, Integer interval) {
        ...
        case QUARTER:
            return CharSequenceUtil.format("{}-Q{}", startTime.getYear(), getQuarterOfYear(startTime));
        case YEAR:
    ...
    public static LocalDateTime atEndOfDay(LocalDateTime date) {
        return date == null ? null : date.toLocalDate().atStartOfDay().with(LocalTime.MAX);
    }
     ...
     * @return 年份的结束时间
     */
    public static LocalDateTime atEndOfYear(LocalDateTime date) {
     ...
     * @return 年份的开始时间
     */
    public static LocalDateTime atStartOfYear(LocalDateTime date) {
