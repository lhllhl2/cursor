package com.jasolar.mis.framework.common.util.http;
...
public class HttpUtils {
    ...
    public String append(String base, Map<String, ?> query, boolean fragment) {
    ...
    public static String post(String url, Map<String, String> headers, String requestBody,String contentType) {
        try (HttpResponse response = HttpRequest.post(url)
                .addHeaders(headers)
