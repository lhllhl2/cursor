 ...
 * 方便 {@link com.fiifoxconn.mis.framework.apilog.core.filter.ApiAccessLogFilter} 记录访问日志
 */
...
public class GlobalResponseBodyHandler implements ResponseBodyAdvice {
    ...
    public boolean supports(MethodParameter returnType, Class converterType) {
        if (ObjectUtil.isNull(returnType) || ObjectUtil.isNull(returnType.getMethod())
                || ObjectUtil.isNull(returnType.getMethod().getReturnType())) {
            return false;
        }
