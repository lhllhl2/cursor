package com.jasolar.mis.framework.swagger.config;
...
import static com.jasolar.mis.framework.web.core.util.WebFrameworkUtils.HEADER_TENANT_ID;
...
public class JasolarSwaggerAutoConfiguration {
    ...
    public static GroupedOpenApi buildGroupedOpenApi(String group, String path) {
        return GroupedOpenApi.builder()
                .group(group)
                .pathsToMatch("/admin-api/" + path + "/**", "/app-api/" + path + "/**", "/budget-api/" + path + "/**")
