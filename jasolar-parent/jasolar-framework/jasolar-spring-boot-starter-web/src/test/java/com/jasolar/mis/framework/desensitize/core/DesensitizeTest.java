package com.jasolar.mis.framework.desensitize.core;

import com.jasolar.mis.framework.common.util.json.JsonUtils;
import com.jasolar.mis.framework.desensitize.core.annotation.Address;
import com.jasolar.mis.framework.desensitize.core.regex.annotation.EmailDesensitize;
import com.jasolar.mis.framework.desensitize.core.regex.annotation.RegexDesensitize;
import com.jasolar.mis.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
   ...
   public void test() {
        ...
        desensitizeDemo.setRegex("你好，我是黄朝晖");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("fiifoxconn");

        // 调用
        DesensitizeDemo d = JsonUtils.parseObject(JsonUtils.toJsonString(desensitizeDemo), DesensitizeDemo.class);
        // 断言
        assertNotNull(d);
        assertEquals("黄**", d.getNickname());
        ...
        assertEquals("fiifoxconn", d.getOrigin());
    }
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "黄朝晖", replacer = "*")
