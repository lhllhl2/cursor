...
@Schema(description = "管理后台 - 供应商主 Response VO")
@Data
public class SupplierRespDTO implements Serializable {

    @Schema(description = "主键", requiredMode = Schema.RequiredMode.REQUIRED, example = "21180")
    private Long id;
