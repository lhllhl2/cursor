...
public class OperateLogRespDTO {
    ...
    @Schema(description = "用户名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "fiifoxconn")
    ...
    private Long bizId;
    @Schema(description = "操作内容", requiredMode = Schema.RequiredMode.REQUIRED, example = "修改编号为 1 的用户信息，将性别从男改成女，将姓名从fiifoxconn改成源码")
