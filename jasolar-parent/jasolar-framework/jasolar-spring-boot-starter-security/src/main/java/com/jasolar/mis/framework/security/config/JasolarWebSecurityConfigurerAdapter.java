...
public class JasolarWebSecurityConfigurerAdapter {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity
                ...
                .authorizeHttpRequests(c -> c
                        ...
                        // 1.3 基于 fiifoxconn.security.permit-all-urls 无需认证
                        .requestMatchers(securityProperties.getPermitAllUrls().toArray(new String[0])).permitAll()

                        // 通过feign调用的 /rpc-api 接口无需认证
                        .requestMatchers(RpcConstants.RPC_API_PREFIX + "/**").permitAll()
                        .requestMatchers("/oauth-api/**").permitAll()

                        // swagger相关的地址无需认证
                        .requestMatchers("/v3/api-docs/**", "/webjars/**", "/swagger-ui", "/swagger-ui/**").permitAll()
                        // Druid 监控
