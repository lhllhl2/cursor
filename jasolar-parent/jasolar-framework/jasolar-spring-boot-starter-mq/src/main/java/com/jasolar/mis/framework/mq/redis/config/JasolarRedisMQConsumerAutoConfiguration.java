...
import com.jasolar.mis.framework.common.enums.DocumentEnum;
import com.jasolar.mis.framework.mq.redis.core.RedisMQTemplate;
import com.jasolar.mis.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import com.jasolar.mis.framework.mq.redis.core.pubsub.AbstractRedisChannelMessageListener;
import com.jasolar.mis.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
...
public class JasolarRedisMQConsumerAutoConfiguration {
    ...
    private static void checkRedisVersion(RedisTemplate<String, ?> redisTemplate) {
        ...
        // 校验最低版本必须大于等于 5.0.0
        int majorVersion = Integer.parseInt(CharSequenceUtil.subBefore(version, '.', false));
        if (majorVersion < 5) {
            throw new IllegalStateException(CharSequenceUtil.format("您当前的 Redis 版本为 {}，小于最低要求的 5.0.0 版本！" +
