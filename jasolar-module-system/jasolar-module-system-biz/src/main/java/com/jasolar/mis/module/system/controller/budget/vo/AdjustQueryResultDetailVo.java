...
@ToString
@ApiModel("预算调整查询响应明细")
public class AdjustQueryResultDetailVo {

    @ApiModelProperty(value = "调整年份", example = "2025")
    private String adjustYear;

    @ApiModelProperty(value = "调整月份", example = "01")
    ...
    @ApiModelProperty(value = "调整类型（0：预算调整-采购额，1：投资额调整，2：预算调整-付款额）", example = "0")
