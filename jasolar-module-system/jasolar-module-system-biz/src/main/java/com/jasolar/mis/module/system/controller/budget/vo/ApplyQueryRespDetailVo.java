...
@ToString
@ApiModel("申请查询响应明细")
public class ApplyQueryRespDetailVo {

    @ApiModelProperty(value = "需求年份", example = "2025")
    private String demandYear;

    @ApiModelProperty(value = "需求月份", example = "01")
    ...
    @ApiModelProperty(value = "元数据（Map格式）", example = "{\"key\":\"value\"}")
