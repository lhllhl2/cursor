...
import com.jasolar.mis.framework.common.validation.Mobile;
...
public class UserSaveReqVO {
    ...
    @Size(max = 100, message = "拼音长度不能超过100个字符")
    ...
    @Size(max = 30, message = "法人编码不能超过30个字符")
    private String legalCode;

    @Schema(description = "法人名称;冗余字段", example = "赵六")
    @Size(max = 100, message = "法人名称不能超过100个字符")
