...
/**
 * Description: 付款/报销明细响应VO（用于申请接口返回）
 * Author : Auto Generated
 * Date : 2025-12-05
 * Version : 1.0
 */
@ApiModel(description = "付款/报销明细响应VO（用于申请接口返回）")
@Data
@NoArgsConstructor
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class ClaimDetailRespVo extends ClaimDetailDetailVo {
     ...
     * 参考值：0.88
     */
    @ApiModelProperty(value = "可用预算占比", example = "0.88", required = false)
