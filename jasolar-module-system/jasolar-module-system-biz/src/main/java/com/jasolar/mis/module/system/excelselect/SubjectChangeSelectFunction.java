 ...
 * Description:
 * Author : Zhou Hai
 * Date : 24/12/2025 17:11
 * Version : 1.0
 */
@Component
public class SubjectChangeSelectFunction implements ExcelColumnSelectFunction {

    @Override
    public List<String> listOptions(Object args) {
        return  Arrays.stream(SubjectEnums.ExcelChangeType.values()).map(SubjectEnums.ExcelChangeType::getDesc).toList();
    }
